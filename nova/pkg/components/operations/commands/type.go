...
func (bo *TypeOperation) Type() component.ComponentType {
	return component.BasicComponentType
}

func NewTypeOperation(id, name, description string) *TypeOperation {
...
func (bo *TypeOperation) Execute(ctx *context.Context,
