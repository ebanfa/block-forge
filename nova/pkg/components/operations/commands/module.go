...
func (bo *ModuleOperation) Type() component.ComponentType {
	return component.BasicComponentType
}

func NewModuleOperation(id, name, description string) *ModuleOperation {
...
func (bo *ModuleOperation) Execute(ctx *context.Context,
