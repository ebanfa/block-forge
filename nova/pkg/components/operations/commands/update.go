...
func (bo *UpdateOperation) Type() component.ComponentType {
	return component.BasicComponentType
}

func NewUpdateOperation(id, name, description string) *UpdateOperation {
...
func (bo *UpdateOperation) Execute(ctx *context.Context,
