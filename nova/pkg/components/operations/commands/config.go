...
func (bo *ConfigOperation) Type() component.ComponentType {
	return component.BasicComponentType
}

func NewConfigOperation(id, name, description string) *ConfigOperation {
...
func (bo *ConfigOperation) Execute(ctx *context.Context,
