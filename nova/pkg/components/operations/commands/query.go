...
func (bo *QueryOperation) Type() component.ComponentType {
	return component.BasicComponentType
}

func NewQueryOperation(id, name, description string) *QueryOperation {
...
func (bo *QueryOperation) Execute(ctx *context.Context,
