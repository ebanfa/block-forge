...
func (bo *InitOperation) Type() component.ComponentType {
	return component.BasicComponentType
}

func NewInitOperation(id, name, description string) *InitOperation {
...
func (bo *InitOperation) Execute(ctx *context.Context,
