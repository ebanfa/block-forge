...
type RemoveModuleOpFactory struct {
}

// CreateComponent creates a new instance of the BuildService.
func (bf *RemoveModuleOpFactory) CreateComponent(config *configApi.ComponentConfig) (component.ComponentInterface, error) {
	// Construct the service
	return NewRemoveModuleOp(config.ID, config.Name, config.Description), nil
}

// BaseComponent represents a concrete implementation of the SystemOperationInterface.
type RemoveModuleOp struct {
	system.BaseSystemOperation // Embedding BaseComponent
}

// Type returns the type of the component.
func (bo *RemoveModuleOp) Type() component.ComponentType {
	return component.BasicComponentType
}

func NewRemoveModuleOp(id, name, description string) *RemoveModuleOp {
	return &RemoveModuleOp{
...
func (bo *RemoveModuleOp) Execute(ctx *context.Context,
